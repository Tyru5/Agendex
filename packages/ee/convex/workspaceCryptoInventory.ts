...
export const WORKSPACE_CRYPTO_INVENTORY = {
  ...
  shareAccessProofs: table({
    encrypted: none,
    plaintext: ['expiresAt', 'createdAt'],
    opaque_token: none,
    relation: ['shareLinkId'],
  ...
  accountDeletionJobs: table({
    encrypted: none,
    plaintext: [
      'status',
      'phase',
      'stripeSubscriptionId',
      'stripeCancellationRequired',
      'stripeCanceledAt',
      'planPhase',
      'attempt',
      'lastError',
    ...
    opaque_token: none,
    relation: ['ownerId', 'activeSubscriptionId', 'activePlanId'],
    unused_when_encrypted: none,
  }),
  agentAvatarUploadReservations: table({
    encrypted: none,
    plaintext: ['agent', 'createdAt', 'expiresAt'],
    opaque_token: none,
    relation: ['ownerId'],
    unused_when_encrypted: none,
  }),
  ...
  daemonHeartbeats: table({
    ...
    opaque_token: none,
    relation: ['ownerId'],
    unused_when_encrypted: ['hostname', 'ipAddress', 'usageSnapshots', 'usageUpdatedAt'],
  }),
