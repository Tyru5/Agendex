...
export const ampAdapter = createStub(
  "amp",
  [join(home, ".amp")],
  ".json"
);
...
export const droidAdapter = createStub(
  "droid",
  [join(home, ".factory", "droids")],
  ".md"
);

export const kiloCliAdapter = createStub(
  "kilo-cli",
  [join(home, ".kilo")],
  ".md"
);

export const windsurfAdapter = createStub(
  "windsurf",
  [join(home, ".cascade_backups")],
  ".md"
);

export const aiderAdapter = createStub(
  "aider",
  [join(home, ".aider")],
